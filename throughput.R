...
png(file="throughput.png",width=750,height=750,bg = "transparent",pointsize = 15)
...
# Define the layout 
plot(xrange,yrange,type="n",yaxt = "n",mgp = c(5, 1, 0),xlab = list("parallelism",font=2,cex=2.3),ylab = list("throughput (event/second)",font=2,cex=2),font.axis=2,font=2,cex.axis=1.2)

yrange <-c(0,200,400,600,800,1000,1200,1400,1600,1800,2000,2200)
axis(2, at = yrange, labels = formatC(yrange, big.mark = ",", format = "d"),
     las = 2,font.axis=2.3,font=2,cex.axis=1.2)
